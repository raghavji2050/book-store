...
<div class="product-area pt-95 xs-mb">
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-menu mb-40 text-center">
                    <ul class="nav justify-content-center" role="tablist">
                        <li><a class="active" href="#Audiobooks" data-bs-toggle="tab" aria-selected="true" role="tab">New Arrival </a></li>
                        <li><a href="#books" data-bs-toggle="tab" aria-selected="false" role="tab" class="" tabindex="-1">OnSale</a></li>
                        <li><a href="#bussiness" data-bs-toggle="tab" aria-selected="false" role="tab" class="" tabindex="-1">Featured Products</a></li>
                    </ul>
                </div>
                <!-- tab-menu-end -->
            </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active show" id="Audiobooks" role="tabpanel">
